                                ...
                                <div class="col-12 col-lg-8">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <select name="coupon"   class="select2 form-select select2-hidden-accessible" data-select2-id="select2_course_select" tabindex="-1" aria-hidden="true">
                                                    
                                                    <c:forEach items="${coupon}" var="c">                                               
                                                        <option value="${c.couponId}" data-select2-id="11">${c.discountRate}%</option>
                                                    </c:forEach>
                                                </select>
                                            </div>                                            
                                        </div>
