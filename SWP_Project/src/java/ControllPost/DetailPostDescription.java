 ...
 * @author hoang
 */
@WebServlet(name = "DetailPostDescription", urlPatterns = {"/DetailPostDescription"})
public class DetailPostDescription extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("adminView/EditPostDescription.jsp").forward(request, response);
