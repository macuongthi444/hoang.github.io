 ...
 * @author hoang
 */
@WebServlet(name="AdminShowAllProducts", urlPatterns={"/AdminShowAllProducts"})
...
//            }
//        }
        request.getRequestDispatcher("adminView/admin-show-all-product.jsp").forward(request, response);
    } 
