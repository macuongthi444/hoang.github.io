 ...
 * @author nguye
 */
@WebServlet(name="ProcessAfterCheckout", urlPatterns={"/ProcessAfterCheckout"})
public class ProcessAfterCheckout extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ProcessAfterCheckout</title>");  
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ProcessAfterCheckout at " + request.getContextPath () + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
...
//        processRequest(request, response);
        String[] productOptionsId = (String[])request.getAttribute("productOptionSelected");
        List<ProductOption> productOptions = (List<ProductOption>)request.getAttribute("productOptions");
