                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4 order-0">
                                    <div class="card">
                                        ...
                                        <table class="datatables-users table border-top dataTable no-footer dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 1180px;">
                                            <thead>
                                                <tr>
                                                    <th class="control sorting_disabled dtr-hidden" rowspan="1" colspan="1" style="width: 0px; display: none;" aria-label="">
                                                    </th>
                                                    <th class="sorting sorting_desc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 350px;" aria-label="User: activate to sort column ascending" aria-sort="descending">Account</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 215px;" aria-label="Plan: activate to sort column ascending">Birth Date</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 117px;" aria-label="Billing: activate to sort column ascending">Gender</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"  aria-label="Billing: activate to sort column ascending">Company</th>
                                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 143px;" aria-label="Actions">Give Order Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach var="delivery" items="${deliveryList}">
                                                    <tr >
                                                            ...
                                                            <div class="d-flex justify-content-start align-items-center user-name">
                                                                <div class="avatar-wrapper">
                                                                    <div class="avatar avatar-sm me-3">
                                                                        <img src="img/${delivery.avatar}" alt="Avatar" class="rounded-circle">
                                                                    </div>
                                                                </div>
                                                                <div class="d-flex flex-column">
                                                                    <a href="app-user-view-account.html" class="text-body text-truncate">
                                                                        <span class="fw-medium">${delivery.fullName}</span>
                                                                    </a>
                                                        ...
                                                        <td>
                                                            <span>${delivery.birthDate}</span>
                                                        </td>


                                                        <td>
                                                            <span class="badge bg-label-success">${delivery.gender ? "Male" : "Female"}</span>
                                                        </td>
                                                        <td>${DeliveryDAO.INSTANCE.getDeliveryCompanyByAccountId(delivery.id)}  </td>
                                                        <td>
                                                            <div class="d-inline-block text-nowrap">
                                                                <button class="btn btn-sm btn-icon">

                                                                    <a href="GiveOrder?deliveryManId=${delivery.id}"><i class="bx bx-edit"></i></a>
