            ...
            <div class="layout-container">
                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    <div class="app-brand demo">
                        <a href="adminView/index.html" class="app-brand-link">
                                                            ...
                                                            <c:forEach items="${ProductDAO.INSTANCE.getProductOptionByProductId(productEntry.productId)}" var="poEntry">
                                                                <tr>
                                                                    ...
                                                                    <td class="image-width">   
                                                                        <div>
                                                                            <img src="img/${ProductDAO.INSTANCE.getImageByProductOptionId(poEntry.getProductOptionId()).imageText}" width="50px" height="50px" alt="alt"/> 
                                                                        </div> 
                                                                    </td>
