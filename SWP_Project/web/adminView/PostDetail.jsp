            ...
            <div class="layout-container">
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <h4 class="pt-3 mb-0">
                                <span class="text-muted fw-light"><a href="/SWP_Project/PostList">Post</a> /</span> Post Details
                            </h4>
                            <hr class="my-4">
                            <h5 class="mb-1">Title</h5>
                            <span class=" text-uppercase fw-bold"> ${postById.postTitle}</span>

                            <hr class="my-4">
                            <c:if test="${accl.id==postById.postByUserMarketing.id}">  
                                <div class="offcanvas-header" style="display: flex; justify-content: flex-start;">
                                    <button class="dt-button add-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser">
                                        <span>
                                            ...
                                            <span class="d-none d-sm-inline-block">Add Post Description</span>
                                        </span>
                                    </button>
                                    <div class="d-flex justify-content-center " style="padding-left: 20px;">

                                        <a href="javascript:;" class="btn btn-primary me-3" data-bs-target="#updatePost"  data-bs-toggle="modal" ><i class="bx bx-pencil me-0 me-sm-1"></i>Update Post</a>
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="me-5">
                                    ...
                                    <p class="text-nowrap "><i class="bx bx-file bx-sm me-2"></i>Post Type: ${postById.postTypeID.postTypeDetail} </p>
                                    <p class="text-nowrap"><i class="bx bx-pencil bx-sm me-2"></i>Person write the post: ${postById.postByUserMarketing.username}</p>

                                </div>
                                <div>
                                    <p class="text-nowrap "><i class="bx bxs-watch bx-sm me-2"></i>Start: ${postById.postStart}</p>
                                    <p class="text-nowrap "><i class="bx bxs-watch bx-sm me-2"></i>End: ${postById.postEnd}</p>
                                </div>
                                <img src="${postById.postImg}" style="width: 70%" alt="alt"/>
                            </div>
                                ...
                                <div class="card g-3 mt-5">
                                    <div class="card-body row g-3">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="card-body">
                                                <%--<c:set var="postDescriptionId" value="${p.postDescriptionId}" />--%>
                                                <!--                                                <form action="PostDetail"> 
                                                                                                    <input type="hidden" value="${p.postDescriptionId}" name="postDescriptionId">
                                                                                                </form>-->


                                                <img class="img-fluid" style="width: 50%" src="${p.postImg}" alt="Img${p.postDescriptionId}">
                                                <input type="hidden" name="idpost" value="${p.postId.postId}">

                                                <c:if test="${accl.id==postById.postByUserMarketing.id}">
                                                    <div class="d-flex justify-content-end pt-3">
                                                        <a href="/SWP_Project/DetailPostDescription?postDescriptionId=${p.postDescriptionId}" class="btn btn-primary me-3"   >Edit</a>

                                                    </div>
                                                </c:if>
                                                <div>
                                                    <p class="mb-4" style="color: blue;" >
                                                        ${p.getPostTitleDescription()}
                ...
                <div class="offcanvas offcanvas-end " tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel" aria-modal="true" role="dialog">
                    <div class="offcanvas-header">
                        <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Add Post Desciption</h5>
                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div class="offcanvas-body mx-0 flex-grow-0">
                        <form action="AddPostDescription" method="post" class="add-new-user pt-0 fv-plugins-bootstrap5 fv-plugins-framework" id="addNewUserForm"  novalidate="novalidate">
                            <input type="hidden" name="postId" value="${postById.postId}">

                            <div class="mb-3 fv-plugins-icon-container">
                                <label class="form-label" for="add-user-fullname">Post Title Description</label>
                                <input type="text" class="form-control" id="add-user-fullname" placeholder="Title" name="PostTitleDescription" aria-label="John Doe">
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>                                     
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="add-user-contact">Post Detail</label>
                                <input type="text" id="add-user-contact" class="form-control phone-mask" placeholder="" aria-label="" name="postDetail">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="add-user-contact">Image</label>
                                <input type="file" id="add-user-contact" class="form-control phone-mask" placeholder="" aria-label="" name="postImg">
                            </div>
                ...
                <div class="modal fade" id="updatePost" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                        <div class="modal-content p-3 p-md-5">
                            <div class="modal-body">
                                ...
                                <form action="UpdatePost" method="post" id="editUserForm" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework"  novalidate="novalidate">
                                    <input type="hidden" name="postId" value="${postById.postId}">

                                    <input type="text" id="modalEditUserName" name="postTitle" class="form-control" placeholder="${postById.postTitle}">
                                    <input type="file" id="modalEditUserName"  name="postImg" class="form-control" >


                                    <div class="col-12 col-md-6 fv-plugins-icon-container">
                                        <label class="form-label" for="modalEditUserFirstName">Start: ${postById.postStart}</label>
                                        <input type="date" id="modalEditUserFirstName" name="postStart" class="form-control">
                                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>

                                    <div class="col-12 col-md-6 fv-plugins-icon-container">
                                        <label class="form-label" for="modalEditUserFirstName">End: ${postById.postEnd}</label>
                                        <input type="date" id="modalEditUserFirstName" name="postEnd" class="form-control">
                                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>

                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="roleName">Post Type: ${postById.postTypeID.postTypeDetail}</label>
                                        <select id="modalEditUserStatus" name="postType" class="form-select" aria-label="Default select example">
                                            <c:forEach items="${requestScope.postType}" var="postType">

                                                <option value="${postType.postTypeID}">${postType.postTypeDetail}</option>

                                            </c:forEach>                                                         
                                        </select>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="roleName">Post Type: ${postById.couponId.discountRate}</label>
                                        <select id="modalEditUserStatus" name="coupon" class="form-select" aria-label="Default select example">
                                            <c:forEach items="${requestScope.coupon}" var="coupon">

                                                <option value="${coupon.couponId}">${coupon.discountRate}</option>
