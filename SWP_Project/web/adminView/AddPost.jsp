                                ...
                                <div class="col-12 col-lg-8">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <select name="type"   class="select2 form-select select2-hidden-accessible" data-select2-id="select2_course_select" tabindex="-1" aria-hidden="true">

                                                    <c:forEach items="${postType}" var="p">                                               
                                                        <option value="${p.postTypeID}" data-select2-id="11">${p.postTypeDetail}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col"><label class="form-label" for="ecommerce-product-sku">Start</label>
                                                    <input type="date" class="form-control" id="ecommerce-product-sku" placeholder="SKU" name="StartDate" aria-label="Product SKU"></div>
                                                <div class="col"><label class="form-label" for="ecommerce-product-barcode">End</label>
                                                    <input type="date" class="form-control" id="ecommerce-product-barcode" placeholder="0123-4567" name="EndDate" aria-label="Product barcode"></div>
                                            </div>
                                            <!-- Description -->

                                            <label class="form-label">Coupon<span class="text-muted">(Optional)</span></label>
                                            <div>
                                                <select name="coupon"  class="select2 form-select select2-hidden-accessible" data-select2-id="select2_course_select" tabindex="-1" >

                                                    <c:forEach items="${coupon}" var="coupon">                                               
                                                        <option value="${coupon.couponId}" data-select2-id="11">${coupon.discountRate}%</option>
                                                    </c:forEach>
                                                </select>
                                            </div>                                            
                                        </div>
                                    ...
                                    <div class="card mb-4">
                                        <div class="mb-3">
                                            ...
                                            <input style="width: 216px;" multiple
                                                   name="postImg" type="file" min="0" placeholder="image" autocomplete="off"/>
                                        </div>
                                    </div>
