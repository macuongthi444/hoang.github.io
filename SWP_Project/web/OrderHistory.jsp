...
<%@page import="DAO.ProductDAO, DAO.OrderDAO, java.util.List, java.util.ArrayList, Model.Product" %>
            ...
            <div class="container py-5">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <c:set var="orderListSize" value="${empty orderList ? 0 : orderList.size()}" />
                            <c:forEach var="order" items="${orderList}" varStatus="loop">
                                <tr>                                   
                                    <td>
                                        <p class="mb-0 mt-4">Order# ${orderListSize - loop.index}</p>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <p class="mb-0 mt-4">${order.getOrderDate()}</p>
                                    </td>
                                    <td class="mb-0 mt-4">
                                        <p class="mb-0 mt-4">${OrderDAO.INSTANCE.getTotalMoneyByOrderId(order.getOrderId())}</p>
                                    </td>
                                    <td>
                                        <p class="mb-0 mt-4" style="color: blue">${OrderDAO.INSTANCE.getOrderStatusByOrderId(order.getOrderId())}</p>
                                    </td>
                                    <td>
