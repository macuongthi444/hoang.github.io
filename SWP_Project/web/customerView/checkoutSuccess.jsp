                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <c:set value="${orderInfo.productOption}" var="productOption"/>
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center" style="width: max-content;">
                                        <c:set value="${productOption.images}" var="imageList"/>
                                        <img src="img/${imageList.isEmpty()?"":imageList.get(0).imageText}" class="img-fluid me-5" style="width: 80px; height: 80px;" alt="">
                                    </div>
                                </th>
                                <td>
                                    <p class="mb-0 mt-4">${productOption.product.productName}</p>
                                </td>
                                <td>
                                    <p id="productOptionPrice${productOption.productOptionId}"
                                        class="mb-0 mt-4">${productOption.price}
                                    </p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4">
                                ...
                                <td>
                                    <p class="mb-0 mt-4" id="totalPrice${productOption.productOptionId}">
                                        ${orderInfo.quantity * orderInfo.productPrice}
                                    </p>
                                </td>
                            </tr>
                            </c:forEach>
