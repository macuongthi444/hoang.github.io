<%-- 
    Document   : contact
    Created on : 12-01-2024, 11:00:43
    Author     : hoang
--%>
...
<!--        <div class="container-fluid page-header py-5">
        ...
        <!-- Contact Start -->
        <div class="container-fluid contact py-5" style="">
                            ...
                            <form action="" class="">
                                <table class="table contact-table" style="color: black;">
                                    <tr>
                                        ...
                                        <td>
                                            <input id="name" name="name" value="${profile.fullName}" required="" style="color: black;"
                                                   autocomplete="off" type="text" class="form-control border-0 py-3" placeholder="Your Name">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
